...
| Version      | 0.4                                                                                                                                                                                 |
| Status       | Draft - Final coverage verification completed                                                                                                                                       |
| Owner        | TBD                                                                                                                                                                                 |
| Last Updated | TBD                                                                                                                                                                                 |
...
| FLOW-DASHBOARD-PLATFORM-VIEW       | View Platform Dashboard                            | FEAT-DASHBOARD-PLATFORM-OVERVIEW                                                                                                                      | Should-have |
| FLOW-CHANNEL-DISCONNECT-LAZADA     | Disconnect Lazada Channel                          | FEAT-CHANNEL-LAZADA-DISCONNECT                                                                                                                        | Should-have |
| FLOW-SYNC-LAZADA-PRODUCT           | Sync Lazada Products                               | FEAT-SYNC-PRODUCT, FEAT-PRODUCT-LAZADA-SYNC-STATUS                                                                                                    | Must-have   |
| FLOW-SYNC-LAZADA-FEES              | Sync Lazada Fees / Discounts / Reconciliation Data | FEAT-SYNC-FEES                                                                                                                                        | Should-have |
| FLOW-INVENTORY-LOW-STOCK-ALERT     | Low Stock Alert                                    | FEAT-INVENTORY-LOW-STOCK-ALERT, FEAT-NOTI-LOW-STOCK                                                                                                   | Should-have |
| FLOW-SUBSCRIPTION-PLAN-MANAGE      | Manage Plan Definition                             | FEAT-SUBSCRIPTION-PLAN-MGMT, FEAT-SUBSCRIPTION-PLAN-LIMITS                                                                                            | Should-have |
| FLOW-SUBSCRIPTION-INVOICE-RECORD   | Invoice / Payment Record                           | FEAT-SUBSCRIPTION-INVOICE                                                                                                                             | Should-have |
...
| MOD-DASHBOARD    | Dashboard                       | Covered         | FLOW-DASHBOARD-SELLER-VIEW, FLOW-DASHBOARD-PLATFORM-VIEW                                                                                                           | Seller dashboard và platform dashboard đều đã có flow.                      |
...
| MOD-CHANNEL      | Sales Channel Management        | Covered         | FLOW-CHANNEL-CONNECT-LAZADA, FLOW-CHANNEL-DISCONNECT-LAZADA                                                                                                        | Connect/disconnect Lazada đều đã có flow.                                   |
| MOD-SYNC         | Real-time / Near Real-time Sync | Covered         | FLOW-SYNC-LAZADA-ORDER, FLOW-SYNC-LAZADA-STOCK, FLOW-SYNC-LAZADA-PRODUCT, FLOW-SYNC-LAZADA-FEES, FLOW-SYNC-ERROR-RETRY, FLOW-SYNC-MANUAL-RESYNC                    | Phụ thuộc verify Lazada API.                                                |
...
| MOD-SUBSCRIPTION | Subscription & Payment          | Covered         | FLOW-SUBSCRIPTION-UPGRADE-PAYMENT, FLOW-SUBSCRIPTION-DOWNGRADE, FLOW-SUBSCRIPTION-PASTDUE-SUSPEND, FLOW-SUBSCRIPTION-PLAN-MANAGE, FLOW-SUBSCRIPTION-INVOICE-RECORD | Payment VNPay QR, plan definition và invoice/payment record đều đã có flow. |
| MOD-AUDIT        | Audit Log                       | Covered         | FLOW-AUDIT-VIEW + Cross-flow Audit Requirements                                                                                                                    | Đủ view/log requirement.                                                    |
| MOD-NOTIFICATION | Notification                    | Covered         | FLOW-NOTIFICATION-HANDLE, FLOW-INVENTORY-LOW-STOCK-ALERT                                                                                                           | Đủ mức core notification và low-stock alert.                                |
