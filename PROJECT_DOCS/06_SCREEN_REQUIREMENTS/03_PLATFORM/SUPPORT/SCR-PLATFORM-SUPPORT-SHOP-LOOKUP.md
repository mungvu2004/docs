# SCR-PLATFORM-SUPPORT-SHOP-LOOKUP - Support Shop Lookup

## Metadata

| Field | Value |
|---|---|
| Screen ID | SCR-PLATFORM-SUPPORT-SHOP-LOOKUP |
| Screen Name | Support Shop Lookup |
| Route | `/platform/support/shops` |
| Screen Type | Platform |
| Module ID | MOD-TENANT, MOD-SYNC |
| Related Feature IDs | FEAT-TENANT-VIEW-SHOP, FEAT-SYNC-ERROR |
| Related Flow IDs | FLOW-DASHBOARD-PLATFORM-VIEW |
| Allowed Roles | ROLE-SHOPHUB-SUPPORT, ROLE-SHOPHUB-ADMIN |
| Priority | Must-have |
| Status | Draft |
...
Tra cứu shop để hỗ trợ, không impersonate.
...
| --- | --- | --- | --- | --- |
| Platform scoped data | Dữ liệu vận hành nền tảng liên quan màn hình. | MOD-TENANT, MOD-SYNC | Yes | Không lộ dữ liệu shop nếu role không có quyền. |
...
| --- | --- | --- | --- | --- | --- |
| ACT-PLATFORM-VIEW | View / Manage Platform Data | ROLE-SHOPHUB-SUPPORT, ROLE-SHOPHUB-ADMIN | User mở hoặc thao tác màn | Dữ liệu hiển thị/cập nhật theo platform permission. | FLOW-DASHBOARD-PLATFORM-VIEW |
...
| --- | --- | --- |
| RULE-PLATFORM-SUPPORT-SHOP-LOOKUP-001 | Màn hình chỉ hiển thị dữ liệu theo đúng role và scope. | FLOW-DASHBOARD-PLATFORM-VIEW |
...
| --- | --- | --- |
| VAL-PLATFORM-SUPPORT-SHOP-LOOKUP-001 | User phải có quyền truy cập màn hình. | Bạn không có quyền truy cập màn hình này. |
| VAL-PLATFORM-SUPPORT-SHOP-LOOKUP-002 | Dữ liệu phải thuộc đúng shop/tenant hoặc platform scope. | Không thể truy cập dữ liệu ngoài phạm vi được cấp quyền. |
...
| --- | --- | --- | --- |
| Q-SCR-PLATFORM-SUPPORT-SHOP-LOOKUP-001 | Field chi tiết của màn platform này cần chốt ở API/Data Model nào? | Ảnh hưởng table/filter/detail. | Open |
...
|---|---|---|
| Screen có Screen ID chưa? | Pass | SCR-PLATFORM-SUPPORT-SHOP-LOOKUP |
| Có route chưa? | Pass | `/platform/support/shops` |
| Có map feature chưa? | Pass | FEAT-TENANT-VIEW-SHOP, FEAT-SYNC-ERROR |
| Có map flow chưa? | Pass | FLOW-DASHBOARD-PLATFORM-VIEW |
| Có allowed roles chưa? | Pass | ROLE-SHOPHUB-SUPPORT, ROLE-SHOPHUB-ADMIN |
