# SCR-PLATFORM-AUDIT-LOG - Platform Audit Log

## Metadata

| Field | Value |
|---|---|
| Screen ID | SCR-PLATFORM-AUDIT-LOG |
| Screen Name | Platform Audit Log |
| Route | `/platform/audit-logs` |
| Screen Type | Platform |
| Module ID | MOD-AUDIT |
| Related Feature IDs | FEAT-AUDIT-USER-ROLE, FEAT-AUDIT-SUBSCRIPTION, FEAT-AUDIT-SYNC |
| Related Flow IDs | FLOW-AUDIT-VIEW |
| Allowed Roles | ROLE-SHOPHUB-SUPER-ADMIN, ROLE-SHOPHUB-ADMIN, ROLE-SHOPHUB-AUDITOR |
| Priority | Must-have |
| Status | Draft |
...
| ROLE-SHOPHUB-AUDITOR | View / Limited by permission | Theo permission matrix. |
...
| --- | --- | --- | --- | --- |
| Platform scoped data | Dữ liệu vận hành nền tảng liên quan màn hình. | MOD-AUDIT | Yes | Không lộ dữ liệu shop nếu role không có quyền. |
...
| --- | --- | --- | --- | --- | --- |
| ACT-PLATFORM-VIEW | View / Manage Platform Data | ROLE-SHOPHUB-SUPER-ADMIN, ROLE-SHOPHUB-ADMIN, ROLE-SHOPHUB-AUDITOR | User mở hoặc thao tác màn | Dữ liệu hiển thị/cập nhật theo platform permission. | FLOW-AUDIT-VIEW |
...
| --- | --- | --- |
| RULE-PLATFORM-AUDIT-LOG-001 | Màn hình chỉ hiển thị dữ liệu theo đúng role và scope. | FLOW-AUDIT-VIEW |
...
| --- | --- | --- |
| VAL-PLATFORM-AUDIT-LOG-001 | User phải có quyền truy cập màn hình. | Bạn không có quyền truy cập màn hình này. |
| VAL-PLATFORM-AUDIT-LOG-002 | Dữ liệu phải thuộc đúng shop/tenant hoặc platform scope. | Không thể truy cập dữ liệu ngoài phạm vi được cấp quyền. |
...
| --- | --- | --- | --- |
| Q-SCR-PLATFORM-AUDIT-LOG-001 | Field chi tiết của màn platform này cần chốt ở API/Data Model nào? | Ảnh hưởng table/filter/detail. | Open |
...
|---|---|---|
| Screen có Screen ID chưa? | Pass | SCR-PLATFORM-AUDIT-LOG |
| Có route chưa? | Pass | `/platform/audit-logs` |
| Có map feature chưa? | Pass | FEAT-AUDIT-USER-ROLE, FEAT-AUDIT-SUBSCRIPTION, FEAT-AUDIT-SYNC |
| Có map flow chưa? | Pass | FLOW-AUDIT-VIEW |
| Có allowed roles chưa? | Pass | ROLE-SHOPHUB-SUPER-ADMIN, ROLE-SHOPHUB-ADMIN, ROLE-SHOPHUB-AUDITOR |
