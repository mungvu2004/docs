# SCR-PLATFORM-USER-LIST - Platform User List

## Metadata

| Field | Value |
|---|---|
| Screen ID | SCR-PLATFORM-USER-LIST |
| Screen Name | Platform User List |
| Route | `/platform/users` |
| Screen Type | Platform |
| Module ID | MOD-USER |
| Related Feature IDs | FEAT-USER-MANAGE-PLATFORM-USER |
...
| --- | --- | --- |
| RULE-PLATFORM-USER-LIST-001 | Màn hình chỉ hiển thị dữ liệu theo đúng role và scope. | FLOW-USER-PLATFORM-INVITE |
...
| --- | --- | --- |
| VAL-PLATFORM-USER-LIST-001 | User phải có quyền truy cập màn hình. | Bạn không có quyền truy cập màn hình này. |
| VAL-PLATFORM-USER-LIST-002 | Dữ liệu phải thuộc đúng shop/tenant hoặc platform scope. | Không thể truy cập dữ liệu ngoài phạm vi được cấp quyền. |
...
| --- | --- | --- | --- |
| Q-SCR-PLATFORM-USER-LIST-001 | Field chi tiết của màn platform này cần chốt ở API/Data Model nào? | Ảnh hưởng table/filter/detail. | Open |
...
|---|---|---|
| Screen có Screen ID chưa? | Pass | SCR-PLATFORM-USER-LIST |
| Có route chưa? | Pass | `/platform/users` |
| Có map feature chưa? | Pass | FEAT-USER-MANAGE-PLATFORM-USER |
