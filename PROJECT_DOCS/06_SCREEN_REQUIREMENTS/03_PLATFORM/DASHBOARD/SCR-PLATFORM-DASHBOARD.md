...
| Field | Value |
|---|---|
| Screen ID | SCR-PLATFORM-DASHBOARD |
| Screen Name | Platform Dashboard |
| Route | `/platform/dashboard` |
| Screen Type | Platform |
| Module ID | MOD-DASHBOARD |
| Related Feature IDs | FEAT-DASHBOARD-PLATFORM-OVERVIEW |
| Related Flow IDs | FLOW-DASHBOARD-PLATFORM-VIEW |
| Allowed Roles | ROLE-SHOPHUB-SUPER-ADMIN, ROLE-SHOPHUB-ADMIN, ROLE-SHOPHUB-BILLING-ADMIN, ROLE-SHOPHUB-INTEGRATION-ADMIN |
...
Xem tổng quan vận hành hệ thống ShopHub.
...
| --- | --- | --- | --- | --- |
| Platform scoped data | Dữ liệu vận hành nền tảng liên quan màn hình. | MOD-DASHBOARD | Yes | Không lộ dữ liệu shop nếu role không có quyền. |
...
| --- | --- | --- | --- | --- | --- |
| ACT-PLATFORM-VIEW | View / Manage Platform Data | ROLE-SHOPHUB-SUPER-ADMIN, ROLE-SHOPHUB-ADMIN, ROLE-SHOPHUB-BILLING-ADMIN, ROLE-SHOPHUB-INTEGRATION-ADMIN | User mở hoặc thao tác màn | Dữ liệu hiển thị/cập nhật theo platform permission. | FLOW-DASHBOARD-PLATFORM-VIEW |
...
| --- | --- | --- |
| RULE-PLATFORM-DASHBOARD-001 | Màn hình chỉ hiển thị dữ liệu theo đúng role và scope. | FLOW-DASHBOARD-PLATFORM-VIEW |
...
| --- | --- | --- |
| VAL-PLATFORM-DASHBOARD-001 | User phải có quyền truy cập màn hình. | Bạn không có quyền truy cập màn hình này. |
| VAL-PLATFORM-DASHBOARD-002 | Dữ liệu phải thuộc đúng shop/tenant hoặc platform scope. | Không thể truy cập dữ liệu ngoài phạm vi được cấp quyền. |
...
| --- | --- | --- | --- |
| Q-SCR-PLATFORM-DASHBOARD-001 | Field chi tiết của màn platform này cần chốt ở API/Data Model nào? | Ảnh hưởng table/filter/detail. | Open |
...
|---|---|---|
| Screen có Screen ID chưa? | Pass | SCR-PLATFORM-DASHBOARD |
| Có route chưa? | Pass | `/platform/dashboard` |
| Có map feature chưa? | Pass | FEAT-DASHBOARD-PLATFORM-OVERVIEW |
| Có map flow chưa? | Pass | FLOW-DASHBOARD-PLATFORM-VIEW |
| Có allowed roles chưa? | Pass | ROLE-SHOPHUB-SUPER-ADMIN, ROLE-SHOPHUB-ADMIN, ROLE-SHOPHUB-BILLING-ADMIN, ROLE-SHOPHUB-INTEGRATION-ADMIN |
