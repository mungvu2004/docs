# SCR-PLATFORM-PAYMENT-INVOICE-RECORDS - Payment / Invoice Records

## Metadata

| Field | Value |
|---|---|
| Screen ID | SCR-PLATFORM-PAYMENT-INVOICE-RECORDS |
| Screen Name | Payment / Invoice Records |
| Route | `/platform/payments` |
| Screen Type | Platform |
| Module ID | MOD-SUBSCRIPTION |
| Related Feature IDs | FEAT-SUBSCRIPTION-INVOICE, FEAT-SUBSCRIPTION-PAYMENT |
| Related Flow IDs | FLOW-SUBSCRIPTION-INVOICE-RECORD, FLOW-SUBSCRIPTION-UPGRADE-PAYMENT |
| Allowed Roles | ROLE-SHOPHUB-BILLING-ADMIN, ROLE-SHOPHUB-SUPER-ADMIN |
| Priority | Must-have |
| Status | Draft |
...
Xem payment/invoice subscription.
...
| --- | --- | --- |
| ROLE-SHOPHUB-BILLING-ADMIN | View / Limited by permission | Theo permission matrix. |
...
| --- | --- | --- | --- | --- |
| Platform scoped data | Dữ liệu vận hành nền tảng liên quan màn hình. | MOD-SUBSCRIPTION | Yes | Không lộ dữ liệu shop nếu role không có quyền. |
...
| --- | --- | --- | --- | --- | --- |
| ACT-PLATFORM-VIEW | View / Manage Platform Data | ROLE-SHOPHUB-BILLING-ADMIN, ROLE-SHOPHUB-SUPER-ADMIN | User mở hoặc thao tác màn | Dữ liệu hiển thị/cập nhật theo platform permission. | FLOW-SUBSCRIPTION-INVOICE-RECORD, FLOW-SUBSCRIPTION-UPGRADE-PAYMENT |
...
| --- | --- | --- |
| RULE-PLATFORM-PAYMENT-INVOICE-RECORDS-001 | Màn hình chỉ hiển thị dữ liệu theo đúng role và scope. | FLOW-SUBSCRIPTION-INVOICE-RECORD, FLOW-SUBSCRIPTION-UPGRADE-PAYMENT |
...
| --- | --- | --- |
| VAL-PLATFORM-PAYMENT-INVOICE-RECORDS-001 | User phải có quyền truy cập màn hình. | Bạn không có quyền truy cập màn hình này. |
| VAL-PLATFORM-PAYMENT-INVOICE-RECORDS-002 | Dữ liệu phải thuộc đúng shop/tenant hoặc platform scope. | Không thể truy cập dữ liệu ngoài phạm vi được cấp quyền. |
...
| --- | --- | --- | --- |
| Q-SCR-PLATFORM-PAYMENT-INVOICE-RECORDS-001 | Field chi tiết của màn platform này cần chốt ở API/Data Model nào? | Ảnh hưởng table/filter/detail. | Open |
...
|---|---|---|
| Screen có Screen ID chưa? | Pass | SCR-PLATFORM-PAYMENT-INVOICE-RECORDS |
| Có route chưa? | Pass | `/platform/payments` |
| Có map feature chưa? | Pass | FEAT-SUBSCRIPTION-INVOICE, FEAT-SUBSCRIPTION-PAYMENT |
| Có map flow chưa? | Pass | FLOW-SUBSCRIPTION-INVOICE-RECORD, FLOW-SUBSCRIPTION-UPGRADE-PAYMENT |
| Có allowed roles chưa? | Pass | ROLE-SHOPHUB-BILLING-ADMIN, ROLE-SHOPHUB-SUPER-ADMIN |
