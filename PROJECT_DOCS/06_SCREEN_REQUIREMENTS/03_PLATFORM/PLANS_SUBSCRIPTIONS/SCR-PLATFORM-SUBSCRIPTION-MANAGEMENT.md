# SCR-PLATFORM-SUBSCRIPTION-MANAGEMENT - Subscription Management

## Metadata

| Field | Value |
|---|---|
| Screen ID | SCR-PLATFORM-SUBSCRIPTION-MANAGEMENT |
| Screen Name | Subscription Management |
| Route | `/platform/subscriptions` |
| Screen Type | Platform |
| Module ID | MOD-SUBSCRIPTION |
| Related Feature IDs | FEAT-SUBSCRIPTION-STATUS, FEAT-SUBSCRIPTION-PLAN-LIMITS |
| Related Flow IDs | FLOW-SUBSCRIPTION-PASTDUE-SUSPEND |
| Allowed Roles | ROLE-SHOPHUB-SUPER-ADMIN, ROLE-SHOPHUB-BILLING-ADMIN |
| Priority | Must-have |
| Status | Draft |
...
Theo dõi subscription của các shop.
...
| --- | --- | --- | --- | --- | --- |
| ACT-PLATFORM-VIEW | View / Manage Platform Data | ROLE-SHOPHUB-SUPER-ADMIN, ROLE-SHOPHUB-BILLING-ADMIN | User mở hoặc thao tác màn | Dữ liệu hiển thị/cập nhật theo platform permission. | FLOW-SUBSCRIPTION-PASTDUE-SUSPEND |
...
| --- | --- | --- |
| RULE-PLATFORM-SUBSCRIPTION-MANAGEMENT-001 | Màn hình chỉ hiển thị dữ liệu theo đúng role và scope. | FLOW-SUBSCRIPTION-PASTDUE-SUSPEND |
...
| --- | --- | --- |
| VAL-PLATFORM-SUBSCRIPTION-MANAGEMENT-001 | User phải có quyền truy cập màn hình. | Bạn không có quyền truy cập màn hình này. |
| VAL-PLATFORM-SUBSCRIPTION-MANAGEMENT-002 | Dữ liệu phải thuộc đúng shop/tenant hoặc platform scope. | Không thể truy cập dữ liệu ngoài phạm vi được cấp quyền. |
...
| --- | --- | --- | --- |
| Q-SCR-PLATFORM-SUBSCRIPTION-MANAGEMENT-001 | Field chi tiết của màn platform này cần chốt ở API/Data Model nào? | Ảnh hưởng table/filter/detail. | Open |
...
|---|---|---|
| Screen có Screen ID chưa? | Pass | SCR-PLATFORM-SUBSCRIPTION-MANAGEMENT |
| Có route chưa? | Pass | `/platform/subscriptions` |
| Có map feature chưa? | Pass | FEAT-SUBSCRIPTION-STATUS, FEAT-SUBSCRIPTION-PLAN-LIMITS |
| Có map flow chưa? | Pass | FLOW-SUBSCRIPTION-PASTDUE-SUSPEND |
| Có allowed roles chưa? | Pass | ROLE-SHOPHUB-SUPER-ADMIN, ROLE-SHOPHUB-BILLING-ADMIN |
