# SCR-PLATFORM-PLAN-MANAGEMENT - Plan Management

## Metadata

| Field | Value |
|---|---|
| Screen ID | SCR-PLATFORM-PLAN-MANAGEMENT |
| Screen Name | Plan Management |
| Route | `/platform/plans` |
| Screen Type | Platform |
| Module ID | MOD-SUBSCRIPTION |
| Related Feature IDs | FEAT-SUBSCRIPTION-PLAN-MGMT, FEAT-SUBSCRIPTION-PLAN-LIMITS |
| Related Flow IDs | FLOW-SUBSCRIPTION-PLAN-MANAGE |
...
Quản lý định nghĩa gói dịch vụ và giới hạn plan.
...
| --- | --- | --- | --- | --- | --- |
| ACT-PLATFORM-VIEW | View / Manage Platform Data | ROLE-SHOPHUB-SUPER-ADMIN, ROLE-SHOPHUB-BILLING-ADMIN | User mở hoặc thao tác màn | Dữ liệu hiển thị/cập nhật theo platform permission. | FLOW-SUBSCRIPTION-PLAN-MANAGE |
...
| --- | --- | --- |
| RULE-PLATFORM-PLAN-MANAGEMENT-001 | Màn hình chỉ hiển thị dữ liệu theo đúng role và scope. | FLOW-SUBSCRIPTION-PLAN-MANAGE |
...
| --- | --- | --- |
| VAL-PLATFORM-PLAN-MANAGEMENT-001 | User phải có quyền truy cập màn hình. | Bạn không có quyền truy cập màn hình này. |
| VAL-PLATFORM-PLAN-MANAGEMENT-002 | Dữ liệu phải thuộc đúng shop/tenant hoặc platform scope. | Không thể truy cập dữ liệu ngoài phạm vi được cấp quyền. |
...
| --- | --- | --- | --- |
| Q-SCR-PLATFORM-PLAN-MANAGEMENT-001 | Field chi tiết của màn platform này cần chốt ở API/Data Model nào? | Ảnh hưởng table/filter/detail. | Open |
...
|---|---|---|
| Screen có Screen ID chưa? | Pass | SCR-PLATFORM-PLAN-MANAGEMENT |
| Có route chưa? | Pass | `/platform/plans` |
| Có map feature chưa? | Pass | FEAT-SUBSCRIPTION-PLAN-MGMT, FEAT-SUBSCRIPTION-PLAN-LIMITS |
| Có map flow chưa? | Pass | FLOW-SUBSCRIPTION-PLAN-MANAGE |
