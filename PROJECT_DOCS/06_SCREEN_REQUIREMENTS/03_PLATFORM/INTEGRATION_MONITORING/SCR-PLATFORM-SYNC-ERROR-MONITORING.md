# SCR-PLATFORM-SYNC-ERROR-MONITORING - Sync Error Monitoring

## Metadata

| Field | Value |
|---|---|
| Screen ID | SCR-PLATFORM-SYNC-ERROR-MONITORING |
| Screen Name | Sync Error Monitoring |
| Route | `/platform/sync/errors` |
| Screen Type | Platform |
| Module ID | MOD-SYNC |
| Related Feature IDs | FEAT-SYNC-ERROR, FEAT-SYNC-RETRY, FEAT-SYNC-LOG |
| Related Flow IDs | FLOW-SYNC-ERROR-RETRY, FLOW-SYNC-MANUAL-RESYNC |
...
Giám sát lỗi đồng bộ toàn hệ thống.
...
| --- | --- | --- | --- | --- |
| Platform scoped data | Dữ liệu vận hành nền tảng liên quan màn hình. | MOD-SYNC | Yes | Không lộ dữ liệu shop nếu role không có quyền. |
...
| --- | --- | --- | --- | --- | --- |
| ACT-PLATFORM-VIEW | View / Manage Platform Data | ROLE-SHOPHUB-INTEGRATION-ADMIN, ROLE-SHOPHUB-ADMIN, ROLE-SHOPHUB-SUPPORT limited | User mở hoặc thao tác màn | Dữ liệu hiển thị/cập nhật theo platform permission. | FLOW-SYNC-ERROR-RETRY, FLOW-SYNC-MANUAL-RESYNC |
...
| --- | --- | --- |
| RULE-PLATFORM-SYNC-ERROR-MONITORING-001 | Màn hình chỉ hiển thị dữ liệu theo đúng role và scope. | FLOW-SYNC-ERROR-RETRY, FLOW-SYNC-MANUAL-RESYNC |
...
| --- | --- | --- |
| VAL-PLATFORM-SYNC-ERROR-MONITORING-001 | User phải có quyền truy cập màn hình. | Bạn không có quyền truy cập màn hình này. |
| VAL-PLATFORM-SYNC-ERROR-MONITORING-002 | Dữ liệu phải thuộc đúng shop/tenant hoặc platform scope. | Không thể truy cập dữ liệu ngoài phạm vi được cấp quyền. |
...
| --- | --- | --- | --- |
| Q-SCR-PLATFORM-SYNC-ERROR-MONITORING-001 | Field chi tiết của màn platform này cần chốt ở API/Data Model nào? | Ảnh hưởng table/filter/detail. | Open |
...
|---|---|---|
| Screen có Screen ID chưa? | Pass | SCR-PLATFORM-SYNC-ERROR-MONITORING |
| Có route chưa? | Pass | `/platform/sync/errors` |
| Có map feature chưa? | Pass | FEAT-SYNC-ERROR, FEAT-SYNC-RETRY, FEAT-SYNC-LOG |
| Có map flow chưa? | Pass | FLOW-SYNC-ERROR-RETRY, FLOW-SYNC-MANUAL-RESYNC |
