# SCR-PLATFORM-MANUAL-RESYNC-REVIEW - Manual Resync Review

## Metadata

| Field | Value |
|---|---|
| Screen ID | SCR-PLATFORM-MANUAL-RESYNC-REVIEW |
| Screen Name | Manual Resync Review |
| Route | `/platform/sync/manual-resync/:requestId` |
| Screen Type | Platform |
| Module ID | MOD-SYNC |
| Related Feature IDs | FEAT-SYNC-MANUAL-RESYNC-APPROVAL |
| Related Flow IDs | FLOW-SYNC-MANUAL-RESYNC |
| Allowed Roles | ROLE-SHOPHUB-INTEGRATION-ADMIN, ROLE-SHOP-OWNER via seller confirmation |
...
Xem/đánh giá yêu cầu resync có ảnh hưởng dữ liệu quan trọng.
...
| ROLE-SHOP-OWNER via seller confirmation | View / Limited by permission | Theo permission matrix. |
...
| --- | --- | --- | --- | --- | --- |
| ACT-PLATFORM-VIEW | View / Manage Platform Data | ROLE-SHOPHUB-INTEGRATION-ADMIN, ROLE-SHOP-OWNER via seller confirmation | User mở hoặc thao tác màn | Dữ liệu hiển thị/cập nhật theo platform permission. | FLOW-SYNC-MANUAL-RESYNC |
...
| --- | --- | --- |
| RULE-PLATFORM-MANUAL-RESYNC-REVIEW-001 | Màn hình chỉ hiển thị dữ liệu theo đúng role và scope. | FLOW-SYNC-MANUAL-RESYNC |
...
| --- | --- | --- |
| VAL-PLATFORM-MANUAL-RESYNC-REVIEW-001 | User phải có quyền truy cập màn hình. | Bạn không có quyền truy cập màn hình này. |
| VAL-PLATFORM-MANUAL-RESYNC-REVIEW-002 | Dữ liệu phải thuộc đúng shop/tenant hoặc platform scope. | Không thể truy cập dữ liệu ngoài phạm vi được cấp quyền. |
...
| --- | --- | --- | --- |
| Q-SCR-PLATFORM-MANUAL-RESYNC-REVIEW-001 | Field chi tiết của màn platform này cần chốt ở API/Data Model nào? | Ảnh hưởng table/filter/detail. | Open |
...
|---|---|---|
| Screen có Screen ID chưa? | Pass | SCR-PLATFORM-MANUAL-RESYNC-REVIEW |
| Có route chưa? | Pass | `/platform/sync/manual-resync/:requestId` |
| Có map feature chưa? | Pass | FEAT-SYNC-MANUAL-RESYNC-APPROVAL |
| Có map flow chưa? | Pass | FLOW-SYNC-MANUAL-RESYNC |
| Có allowed roles chưa? | Pass | ROLE-SHOPHUB-INTEGRATION-ADMIN, ROLE-SHOP-OWNER via seller confirmation |
