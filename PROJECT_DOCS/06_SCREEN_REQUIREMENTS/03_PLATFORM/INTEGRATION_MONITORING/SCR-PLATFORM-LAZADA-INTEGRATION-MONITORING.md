# SCR-PLATFORM-LAZADA-INTEGRATION-MONITORING - Lazada Integration Monitoring

## Metadata

| Field | Value |
|---|---|
| Screen ID | SCR-PLATFORM-LAZADA-INTEGRATION-MONITORING |
| Screen Name | Lazada Integration Monitoring |
| Route | `/platform/integrations/lazada` |
| Screen Type | Platform |
| Module ID | MOD-CHANNEL, MOD-SYNC |
| Related Feature IDs | FEAT-CHANNEL-CONNECTION-STATUS, FEAT-SYNC-LOG, FEAT-SYNC-ERROR |
| Related Flow IDs | FLOW-CHANNEL-CONNECT-LAZADA, FLOW-SYNC-ERROR-RETRY |
| Allowed Roles | ROLE-SHOPHUB-INTEGRATION-ADMIN, ROLE-SHOPHUB-ADMIN, ROLE-SHOPHUB-SUPPORT limited |
| Priority | Must-have |
| Status | Draft |
...
Giám sát kết nối Lazada toàn hệ thống.
...
| --- | --- | --- |
| ROLE-SHOPHUB-INTEGRATION-ADMIN | View / Limited by permission | Theo permission matrix. |
| ROLE-SHOPHUB-ADMIN | View / Limited by permission | Theo permission matrix. |
| ROLE-SHOPHUB-SUPPORT limited | View / Limited by permission | Theo permission matrix. |
...
| --- | --- | --- | --- | --- |
| Platform scoped data | Dữ liệu vận hành nền tảng liên quan màn hình. | MOD-CHANNEL, MOD-SYNC | Yes | Không lộ dữ liệu shop nếu role không có quyền. |
...
| --- | --- | --- | --- | --- | --- |
| ACT-PLATFORM-VIEW | View / Manage Platform Data | ROLE-SHOPHUB-INTEGRATION-ADMIN, ROLE-SHOPHUB-ADMIN, ROLE-SHOPHUB-SUPPORT limited | User mở hoặc thao tác màn | Dữ liệu hiển thị/cập nhật theo platform permission. | FLOW-CHANNEL-CONNECT-LAZADA, FLOW-SYNC-ERROR-RETRY |
...
| --- | --- | --- |
| RULE-PLATFORM-LAZADA-INTEGRATION-MONITORING-001 | Màn hình chỉ hiển thị dữ liệu theo đúng role và scope. | FLOW-CHANNEL-CONNECT-LAZADA, FLOW-SYNC-ERROR-RETRY |
...
| --- | --- | --- |
| VAL-PLATFORM-LAZADA-INTEGRATION-MONITORING-001 | User phải có quyền truy cập màn hình. | Bạn không có quyền truy cập màn hình này. |
| VAL-PLATFORM-LAZADA-INTEGRATION-MONITORING-002 | Dữ liệu phải thuộc đúng shop/tenant hoặc platform scope. | Không thể truy cập dữ liệu ngoài phạm vi được cấp quyền. |
...
| --- | --- | --- | --- |
| Q-SCR-PLATFORM-LAZADA-INTEGRATION-MONITORING-001 | Field chi tiết của màn platform này cần chốt ở API/Data Model nào? | Ảnh hưởng table/filter/detail. | Open |
...
|---|---|---|
| Screen có Screen ID chưa? | Pass | SCR-PLATFORM-LAZADA-INTEGRATION-MONITORING |
| Có route chưa? | Pass | `/platform/integrations/lazada` |
| Có map feature chưa? | Pass | FEAT-CHANNEL-CONNECTION-STATUS, FEAT-SYNC-LOG, FEAT-SYNC-ERROR |
| Có map flow chưa? | Pass | FLOW-CHANNEL-CONNECT-LAZADA, FLOW-SYNC-ERROR-RETRY |
| Có allowed roles chưa? | Pass | ROLE-SHOPHUB-INTEGRATION-ADMIN, ROLE-SHOPHUB-ADMIN, ROLE-SHOPHUB-SUPPORT limited |
