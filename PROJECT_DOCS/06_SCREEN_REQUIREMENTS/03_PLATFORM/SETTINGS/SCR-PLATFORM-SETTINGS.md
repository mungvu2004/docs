# SCR-PLATFORM-SETTINGS - Platform Settings

## Metadata

| Field | Value |
|---|---|
| Screen ID | SCR-PLATFORM-SETTINGS |
| Screen Name | Platform Settings |
| Route | `/platform/settings` |
| Screen Type | Platform |
| Module ID | MOD-SETTING |
| Related Feature IDs | FEAT-SETTING-PLATFORM |
...
| --- | --- | --- | --- | --- |
| Platform scoped data | Dữ liệu vận hành nền tảng liên quan màn hình. | MOD-SETTING | Yes | Không lộ dữ liệu shop nếu role không có quyền. |
...
| --- | --- | --- | --- | --- | --- |
| ACT-PLATFORM-VIEW | View / Manage Platform Data | ROLE-SHOPHUB-SUPER-ADMIN, ROLE-SHOPHUB-ADMIN | User mở hoặc thao tác màn | Dữ liệu hiển thị/cập nhật theo platform permission. | FLOW-SETTING-MANAGE |
...
| --- | --- | --- |
| RULE-PLATFORM-SETTINGS-001 | Màn hình chỉ hiển thị dữ liệu theo đúng role và scope. | FLOW-SETTING-MANAGE |
...
| --- | --- | --- |
| VAL-PLATFORM-SETTINGS-001 | User phải có quyền truy cập màn hình. | Bạn không có quyền truy cập màn hình này. |
| VAL-PLATFORM-SETTINGS-002 | Dữ liệu phải thuộc đúng shop/tenant hoặc platform scope. | Không thể truy cập dữ liệu ngoài phạm vi được cấp quyền. |
...
| --- | --- | --- | --- |
| Q-SCR-PLATFORM-SETTINGS-001 | Field chi tiết của màn platform này cần chốt ở API/Data Model nào? | Ảnh hưởng table/filter/detail. | Open |
...
|---|---|---|
| Screen có Screen ID chưa? | Pass | SCR-PLATFORM-SETTINGS |
| Có route chưa? | Pass | `/platform/settings` |
| Có map feature chưa? | Pass | FEAT-SETTING-PLATFORM |
