# SCR-PLATFORM-SHOP-LIST - Shop List

## Metadata

| Field | Value |
|---|---|
| Screen ID | SCR-PLATFORM-SHOP-LIST |
| Screen Name | Shop List |
| Route | `/platform/shops` |
| Screen Type | Platform |
| Module ID | MOD-TENANT |
| Related Feature IDs | FEAT-TENANT-VIEW-SHOP, FEAT-TENANT-SHOP-STATUS |
| Related Flow IDs | FLOW-TENANT-ONBOARD-SHOP, FLOW-TENANT-SHOP-SUSPEND-RESTORE |
| Allowed Roles | ROLE-SHOPHUB-SUPER-ADMIN, ROLE-SHOPHUB-ADMIN, ROLE-SHOPHUB-SUPPORT |
| Priority | Must-have |
| Status | Draft |
...
| --- | --- | --- | --- | --- | --- |
| ACT-PLATFORM-VIEW | View / Manage Platform Data | ROLE-SHOPHUB-SUPER-ADMIN, ROLE-SHOPHUB-ADMIN, ROLE-SHOPHUB-SUPPORT | User mở hoặc thao tác màn | Dữ liệu hiển thị/cập nhật theo platform permission. | FLOW-TENANT-ONBOARD-SHOP, FLOW-TENANT-SHOP-SUSPEND-RESTORE |
...
| --- | --- | --- |
| RULE-PLATFORM-SHOP-LIST-001 | Màn hình chỉ hiển thị dữ liệu theo đúng role và scope. | FLOW-TENANT-ONBOARD-SHOP, FLOW-TENANT-SHOP-SUSPEND-RESTORE |
...
| --- | --- | --- |
| VAL-PLATFORM-SHOP-LIST-001 | User phải có quyền truy cập màn hình. | Bạn không có quyền truy cập màn hình này. |
| VAL-PLATFORM-SHOP-LIST-002 | Dữ liệu phải thuộc đúng shop/tenant hoặc platform scope. | Không thể truy cập dữ liệu ngoài phạm vi được cấp quyền. |
...
| --- | --- | --- | --- |
| Q-SCR-PLATFORM-SHOP-LIST-001 | Field chi tiết của màn platform này cần chốt ở API/Data Model nào? | Ảnh hưởng table/filter/detail. | Open |
...
|---|---|---|
| Screen có Screen ID chưa? | Pass | SCR-PLATFORM-SHOP-LIST |
| Có route chưa? | Pass | `/platform/shops` |
| Có map feature chưa? | Pass | FEAT-TENANT-VIEW-SHOP, FEAT-TENANT-SHOP-STATUS |
| Có map flow chưa? | Pass | FLOW-TENANT-ONBOARD-SHOP, FLOW-TENANT-SHOP-SUSPEND-RESTORE |
| Có allowed roles chưa? | Pass | ROLE-SHOPHUB-SUPER-ADMIN, ROLE-SHOPHUB-ADMIN, ROLE-SHOPHUB-SUPPORT |
