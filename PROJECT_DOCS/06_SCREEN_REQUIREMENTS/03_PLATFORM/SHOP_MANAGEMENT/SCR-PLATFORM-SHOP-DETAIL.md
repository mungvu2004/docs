# SCR-PLATFORM-SHOP-DETAIL - Shop Detail

## Metadata

| Field | Value |
|---|---|
| Screen ID | SCR-PLATFORM-SHOP-DETAIL |
| Screen Name | Shop Detail |
| Route | `/platform/shops/:shopId` |
| Screen Type | Platform |
| Module ID | MOD-TENANT |
| Related Feature IDs | FEAT-TENANT-VIEW-SHOP, FEAT-TENANT-UPDATE-SHOP, FEAT-TENANT-SHOP-STATUS |
| Related Flow IDs | FLOW-TENANT-SHOP-SUSPEND-RESTORE |
| Allowed Roles | ROLE-SHOPHUB-SUPER-ADMIN, ROLE-SHOPHUB-ADMIN, ROLE-SHOPHUB-SUPPORT, ROLE-SHOPHUB-BILLING-ADMIN limited |
| Priority | Must-have |
| Status | Draft |
...
Xem chi tiết shop, trạng thái, gói, sync summary.
...
| ROLE-SHOPHUB-SUPPORT | View / Limited by permission | Theo permission matrix. |
| ROLE-SHOPHUB-BILLING-ADMIN limited | View / Limited by permission | Theo permission matrix. |
...
| --- | --- | --- | --- | --- |
| Platform scoped data | Dữ liệu vận hành nền tảng liên quan màn hình. | MOD-TENANT | Yes | Không lộ dữ liệu shop nếu role không có quyền. |
...
| --- | --- | --- | --- | --- | --- |
| ACT-PLATFORM-VIEW | View / Manage Platform Data | ROLE-SHOPHUB-SUPER-ADMIN, ROLE-SHOPHUB-ADMIN, ROLE-SHOPHUB-SUPPORT, ROLE-SHOPHUB-BILLING-ADMIN limited | User mở hoặc thao tác màn | Dữ liệu hiển thị/cập nhật theo platform permission. | FLOW-TENANT-SHOP-SUSPEND-RESTORE |
...
| --- | --- | --- |
| RULE-PLATFORM-SHOP-DETAIL-001 | Màn hình chỉ hiển thị dữ liệu theo đúng role và scope. | FLOW-TENANT-SHOP-SUSPEND-RESTORE |
...
| --- | --- | --- |
| VAL-PLATFORM-SHOP-DETAIL-001 | User phải có quyền truy cập màn hình. | Bạn không có quyền truy cập màn hình này. |
| VAL-PLATFORM-SHOP-DETAIL-002 | Dữ liệu phải thuộc đúng shop/tenant hoặc platform scope. | Không thể truy cập dữ liệu ngoài phạm vi được cấp quyền. |
...
| --- | --- | --- | --- |
| Q-SCR-PLATFORM-SHOP-DETAIL-001 | Field chi tiết của màn platform này cần chốt ở API/Data Model nào? | Ảnh hưởng table/filter/detail. | Open |
...
|---|---|---|
| Screen có Screen ID chưa? | Pass | SCR-PLATFORM-SHOP-DETAIL |
| Có route chưa? | Pass | `/platform/shops/:shopId` |
| Có map feature chưa? | Pass | FEAT-TENANT-VIEW-SHOP, FEAT-TENANT-UPDATE-SHOP, FEAT-TENANT-SHOP-STATUS |
| Có map flow chưa? | Pass | FLOW-TENANT-SHOP-SUSPEND-RESTORE |
| Có allowed roles chưa? | Pass | ROLE-SHOPHUB-SUPER-ADMIN, ROLE-SHOPHUB-ADMIN, ROLE-SHOPHUB-SUPPORT, ROLE-SHOPHUB-BILLING-ADMIN limited |
