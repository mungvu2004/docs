# SCR-PLATFORM-SHOP-SUSPEND-RESTORE - Suspend / Restore Shop

## Metadata

| Field | Value |
|---|---|
| Screen ID | SCR-PLATFORM-SHOP-SUSPEND-RESTORE |
| Screen Name | Suspend / Restore Shop |
| Route | `/platform/shops/:shopId/status` |
| Screen Type | Platform |
| Module ID | MOD-TENANT |
| Related Feature IDs | FEAT-TENANT-SHOP-STATUS |
| Related Flow IDs | FLOW-TENANT-SHOP-SUSPEND-RESTORE |
| Allowed Roles | ROLE-SHOPHUB-SUPER-ADMIN, ROLE-SHOPHUB-ADMIN, ROLE-SHOPHUB-BILLING-ADMIN billing-related |
| Priority | Must-have |
| Status | Draft |
...
| ROLE-SHOPHUB-BILLING-ADMIN billing-related | View / Limited by permission | Theo permission matrix. |
...
| --- | --- | --- | --- | --- | --- |
| ACT-PLATFORM-VIEW | View / Manage Platform Data | ROLE-SHOPHUB-SUPER-ADMIN, ROLE-SHOPHUB-ADMIN, ROLE-SHOPHUB-BILLING-ADMIN billing-related | User mở hoặc thao tác màn | Dữ liệu hiển thị/cập nhật theo platform permission. | FLOW-TENANT-SHOP-SUSPEND-RESTORE |
...
| --- | --- | --- |
| RULE-PLATFORM-SHOP-SUSPEND-RESTORE-001 | Màn hình chỉ hiển thị dữ liệu theo đúng role và scope. | FLOW-TENANT-SHOP-SUSPEND-RESTORE |
...
| --- | --- | --- |
| VAL-PLATFORM-SHOP-SUSPEND-RESTORE-001 | User phải có quyền truy cập màn hình. | Bạn không có quyền truy cập màn hình này. |
| VAL-PLATFORM-SHOP-SUSPEND-RESTORE-002 | Dữ liệu phải thuộc đúng shop/tenant hoặc platform scope. | Không thể truy cập dữ liệu ngoài phạm vi được cấp quyền. |
...
| --- | --- | --- | --- |
| Q-SCR-PLATFORM-SHOP-SUSPEND-RESTORE-001 | Field chi tiết của màn platform này cần chốt ở API/Data Model nào? | Ảnh hưởng table/filter/detail. | Open |
...
|---|---|---|
| Screen có Screen ID chưa? | Pass | SCR-PLATFORM-SHOP-SUSPEND-RESTORE |
| Có route chưa? | Pass | `/platform/shops/:shopId/status` |
| Có map feature chưa? | Pass | FEAT-TENANT-SHOP-STATUS |
| Có map flow chưa? | Pass | FLOW-TENANT-SHOP-SUSPEND-RESTORE |
| Có allowed roles chưa? | Pass | ROLE-SHOPHUB-SUPER-ADMIN, ROLE-SHOPHUB-ADMIN, ROLE-SHOPHUB-BILLING-ADMIN billing-related |
