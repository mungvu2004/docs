# SCR-SHOP-USER-LIST - Shop User List

## Metadata

| Field | Value |
|---|---|
| Screen ID | SCR-SHOP-USER-LIST |
| Screen Name | Shop User List |
| Route | `/app/users` |
| Screen Type | Seller |
| Module ID | MOD-USER |
| Related Feature IDs | FEAT-USER-LIST-SHOP-USERS, FEAT-USER-DEACTIVATE-SHOP-USER |
...
| --- | --- | --- |
| RULE-SHOP-USER-LIST-001 | Màn hình chỉ hiển thị dữ liệu theo đúng role và scope. | FLOW-USER-INVITE-SHOP-USER |
...
| --- | --- | --- |
| VAL-SHOP-USER-LIST-001 | User phải có quyền truy cập màn hình. | Bạn không có quyền truy cập màn hình này. |
| VAL-SHOP-USER-LIST-002 | Dữ liệu phải thuộc đúng shop/tenant hoặc platform scope. | Không thể truy cập dữ liệu ngoài phạm vi được cấp quyền. |
...
| --- | --- | --- | --- |
| Q-SCR-SHOP-USER-LIST-001 | Permission chi tiết cho từng field/action sẽ chốt ở Permission Matrix thế nào? | Ảnh hưởng UI action visibility. | Open |
...
|---|---|---|
| Screen có Screen ID chưa? | Pass | SCR-SHOP-USER-LIST |
| Có route chưa? | Pass | `/app/users` |
| Có map feature chưa? | Pass | FEAT-USER-LIST-SHOP-USERS, FEAT-USER-DEACTIVATE-SHOP-USER |
