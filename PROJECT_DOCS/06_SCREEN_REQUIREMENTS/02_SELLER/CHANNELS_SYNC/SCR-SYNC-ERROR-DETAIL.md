# SCR-SYNC-ERROR-DETAIL - Sync Error Detail

## Metadata

| Field | Value |
|---|---|
| Screen ID | SCR-SYNC-ERROR-DETAIL |
| Screen Name | Sync Error Detail |
| Route | `/app/sync/errors/:syncErrorId` |
| Screen Type | Seller |
...
Xem chi tiết lỗi sync và hướng xử lý/retry.
...
| --- | --- | --- |
| RULE-SYNC-ERROR-DETAIL-001 | Màn hình chỉ hiển thị dữ liệu theo đúng role và scope. | FLOW-CHANNEL-CONNECT-LAZADA, FLOW-CHANNEL-DISCONNECT-LAZADA, FLOW-SYNC-ERROR-RETRY, FLOW-SYNC-MANUAL-RESYNC |
...
| --- | --- | --- |
| VAL-SYNC-ERROR-DETAIL-001 | User phải có quyền truy cập màn hình. | Bạn không có quyền truy cập màn hình này. |
| VAL-SYNC-ERROR-DETAIL-002 | Dữ liệu phải thuộc đúng shop/tenant hoặc platform scope. | Không thể truy cập dữ liệu ngoài phạm vi được cấp quyền. |
...
| --- | --- | --- | --- |
| Q-SCR-SYNC-ERROR-DETAIL-001 | Lazada API/webhook cụ thể hỗ trợ dữ liệu nào? | Ảnh hưởng data displayed và action retry/resync. | Pending API Verification |
...
|---|---|---|
| Screen có Screen ID chưa? | Pass | SCR-SYNC-ERROR-DETAIL |
| Có route chưa? | Pass | `/app/sync/errors/:syncErrorId` |
