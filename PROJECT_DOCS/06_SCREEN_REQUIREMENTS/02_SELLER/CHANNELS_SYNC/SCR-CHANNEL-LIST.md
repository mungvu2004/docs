# SCR-CHANNEL-LIST - Channel List

## Metadata

| Field | Value |
|---|---|
| Screen ID | SCR-CHANNEL-LIST |
| Screen Name | Channel List |
| Route | `/app/channels` |
| Screen Type | Seller |
...
Xem danh sách kênh bán và trạng thái kết nối.
...
| --- | --- | --- |
| RULE-CHANNEL-LIST-001 | Màn hình chỉ hiển thị dữ liệu theo đúng role và scope. | FLOW-CHANNEL-CONNECT-LAZADA, FLOW-CHANNEL-DISCONNECT-LAZADA, FLOW-SYNC-ERROR-RETRY, FLOW-SYNC-MANUAL-RESYNC |
...
| --- | --- | --- |
| VAL-CHANNEL-LIST-001 | User phải có quyền truy cập màn hình. | Bạn không có quyền truy cập màn hình này. |
| VAL-CHANNEL-LIST-002 | Dữ liệu phải thuộc đúng shop/tenant hoặc platform scope. | Không thể truy cập dữ liệu ngoài phạm vi được cấp quyền. |
...
| --- | --- | --- | --- |
| Q-SCR-CHANNEL-LIST-001 | Lazada API/webhook cụ thể hỗ trợ dữ liệu nào? | Ảnh hưởng data displayed và action retry/resync. | Pending API Verification |
...
|---|---|---|
| Screen có Screen ID chưa? | Pass | SCR-CHANNEL-LIST |
| Có route chưa? | Pass | `/app/channels` |
