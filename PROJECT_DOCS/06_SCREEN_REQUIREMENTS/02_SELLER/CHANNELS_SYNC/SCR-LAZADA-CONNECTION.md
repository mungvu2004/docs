# SCR-LAZADA-CONNECTION - Lazada Connection

## Metadata

| Field | Value |
|---|---|
| Screen ID | SCR-LAZADA-CONNECTION |
| Screen Name | Lazada Connection |
| Route | `/app/channels/lazada/connect` |
| Screen Type | Seller |
...
Kết nối shop với Lazada qua quy trình xác thực.
...
| --- | --- | --- |
| RULE-LAZADA-CONNECTION-001 | Màn hình chỉ hiển thị dữ liệu theo đúng role và scope. | FLOW-CHANNEL-CONNECT-LAZADA, FLOW-CHANNEL-DISCONNECT-LAZADA, FLOW-SYNC-ERROR-RETRY, FLOW-SYNC-MANUAL-RESYNC |
...
| --- | --- | --- |
| VAL-LAZADA-CONNECTION-001 | User phải có quyền truy cập màn hình. | Bạn không có quyền truy cập màn hình này. |
| VAL-LAZADA-CONNECTION-002 | Dữ liệu phải thuộc đúng shop/tenant hoặc platform scope. | Không thể truy cập dữ liệu ngoài phạm vi được cấp quyền. |
...
| --- | --- | --- | --- |
| Q-SCR-LAZADA-CONNECTION-001 | Lazada API/webhook cụ thể hỗ trợ dữ liệu nào? | Ảnh hưởng data displayed và action retry/resync. | Pending API Verification |
...
|---|---|---|
| Screen có Screen ID chưa? | Pass | SCR-LAZADA-CONNECTION |
| Có route chưa? | Pass | `/app/channels/lazada/connect` |
