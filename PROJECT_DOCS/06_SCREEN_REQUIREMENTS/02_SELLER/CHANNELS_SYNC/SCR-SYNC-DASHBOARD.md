# SCR-SYNC-DASHBOARD - Sync Dashboard

## Metadata

| Field | Value |
|---|---|
| Screen ID | SCR-SYNC-DASHBOARD |
| Screen Name | Sync Dashboard |
| Route | `/app/sync` |
| Screen Type | Seller |
...
Xem tổng quan trạng thái đồng bộ và lỗi sync.
...
| --- | --- | --- |
| RULE-SYNC-DASHBOARD-001 | Màn hình chỉ hiển thị dữ liệu theo đúng role và scope. | FLOW-CHANNEL-CONNECT-LAZADA, FLOW-CHANNEL-DISCONNECT-LAZADA, FLOW-SYNC-ERROR-RETRY, FLOW-SYNC-MANUAL-RESYNC |
...
| --- | --- | --- |
| VAL-SYNC-DASHBOARD-001 | User phải có quyền truy cập màn hình. | Bạn không có quyền truy cập màn hình này. |
| VAL-SYNC-DASHBOARD-002 | Dữ liệu phải thuộc đúng shop/tenant hoặc platform scope. | Không thể truy cập dữ liệu ngoài phạm vi được cấp quyền. |
...
| --- | --- | --- | --- |
| Q-SCR-SYNC-DASHBOARD-001 | Lazada API/webhook cụ thể hỗ trợ dữ liệu nào? | Ảnh hưởng data displayed và action retry/resync. | Pending API Verification |
...
|---|---|---|
| Screen có Screen ID chưa? | Pass | SCR-SYNC-DASHBOARD |
| Có route chưa? | Pass | `/app/sync` |
