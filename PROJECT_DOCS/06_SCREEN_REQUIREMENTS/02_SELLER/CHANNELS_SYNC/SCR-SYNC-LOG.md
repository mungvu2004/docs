# SCR-SYNC-LOG - Sync Log

## Metadata

| Field | Value |
|---|---|
| Screen ID | SCR-SYNC-LOG |
| Screen Name | Sync Log |
| Route | `/app/sync/logs` |
| Screen Type | Seller |
...
Xem lịch sử đồng bộ order/product/stock/fees.
...
| --- | --- | --- |
| RULE-SYNC-LOG-001 | Màn hình chỉ hiển thị dữ liệu theo đúng role và scope. | FLOW-CHANNEL-CONNECT-LAZADA, FLOW-CHANNEL-DISCONNECT-LAZADA, FLOW-SYNC-ERROR-RETRY, FLOW-SYNC-MANUAL-RESYNC |
...
| --- | --- | --- |
| VAL-SYNC-LOG-001 | User phải có quyền truy cập màn hình. | Bạn không có quyền truy cập màn hình này. |
| VAL-SYNC-LOG-002 | Dữ liệu phải thuộc đúng shop/tenant hoặc platform scope. | Không thể truy cập dữ liệu ngoài phạm vi được cấp quyền. |
...
| --- | --- | --- | --- |
| Q-SCR-SYNC-LOG-001 | Lazada API/webhook cụ thể hỗ trợ dữ liệu nào? | Ảnh hưởng data displayed và action retry/resync. | Pending API Verification |
...
|---|---|---|
| Screen có Screen ID chưa? | Pass | SCR-SYNC-LOG |
| Có route chưa? | Pass | `/app/sync/logs` |
