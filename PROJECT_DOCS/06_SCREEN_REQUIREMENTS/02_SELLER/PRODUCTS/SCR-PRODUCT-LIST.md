# SCR-PRODUCT-LIST - Product List

## Metadata

| Field | Value |
|---|---|
| Screen ID | SCR-PRODUCT-LIST |
| Screen Name | Product List |
| Route | `/app/products` |
| Screen Type | Seller |
...
| Related Flow IDs | FLOW-PRODUCT-UPDATE, FLOW-PRODUCT-DEACTIVATE |
...
Xem, tìm kiếm, lọc và thao tác nhanh trên danh sách sản phẩm.
...
| --- | --- | --- |
| RULE-PRODUCT-LIST-001 | Màn hình chỉ hiển thị dữ liệu theo đúng role và scope. | FLOW-PRODUCT-UPDATE, FLOW-PRODUCT-DEACTIVATE |
...
| --- | --- | --- |
| VAL-PRODUCT-LIST-001 | User phải có quyền truy cập màn hình. | Bạn không có quyền truy cập màn hình này. |
| VAL-PRODUCT-LIST-002 | Dữ liệu phải thuộc đúng shop/tenant hoặc platform scope. | Không thể truy cập dữ liệu ngoài phạm vi được cấp quyền. |
...
| --- | --- | --- | --- |
| Q-SCR-PRODUCT-LIST-001 | Danh sách field product Lazada hỗ trợ sync chính xác là gì? | Ảnh hưởng form và sync status. | Pending API Verification |
...
|---|---|---|
| Screen có Screen ID chưa? | Pass | SCR-PRODUCT-LIST |
| Có route chưa? | Pass | `/app/products` |
...
| Có map flow chưa? | Pass | FLOW-PRODUCT-UPDATE, FLOW-PRODUCT-DEACTIVATE |
