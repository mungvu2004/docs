# SCR-PRODUCT-EDIT - Edit Product

## Metadata

| Field | Value |
|---|---|
| Screen ID | SCR-PRODUCT-EDIT |
| Screen Name | Edit Product |
| Route | `/app/products/:productId/edit` |
| Screen Type | Seller |
...
Cập nhật thông tin sản phẩm, giá, giá vốn, trạng thái và field cần sync.
...
| --- | --- | --- |
| RULE-PRODUCT-EDIT-001 | Màn hình chỉ hiển thị dữ liệu theo đúng role và scope. | FLOW-PRODUCT-UPDATE, FLOW-PRODUCT-UPDATE-STATUS |
...
| --- | --- | --- |
| VAL-PRODUCT-EDIT-001 | User phải có quyền truy cập màn hình. | Bạn không có quyền truy cập màn hình này. |
| VAL-PRODUCT-EDIT-002 | Dữ liệu phải thuộc đúng shop/tenant hoặc platform scope. | Không thể truy cập dữ liệu ngoài phạm vi được cấp quyền. |
...
| --- | --- | --- | --- |
| Q-SCR-PRODUCT-EDIT-001 | Danh sách field product Lazada hỗ trợ sync chính xác là gì? | Ảnh hưởng form và sync status. | Pending API Verification |
...
|---|---|---|
| Screen có Screen ID chưa? | Pass | SCR-PRODUCT-EDIT |
| Có route chưa? | Pass | `/app/products/:productId/edit` |
