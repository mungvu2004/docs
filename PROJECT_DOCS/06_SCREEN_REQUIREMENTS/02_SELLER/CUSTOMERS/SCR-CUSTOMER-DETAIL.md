# SCR-CUSTOMER-DETAIL - Customer Detail

## Metadata

| Field | Value |
|---|---|
| Screen ID | SCR-CUSTOMER-DETAIL |
...
Xem thông tin khách, lịch sử đơn hàng và ghi chú chăm sóc.
...
| --- | --- | --- |
| RULE-CUSTOMER-DETAIL-001 | Màn hình chỉ hiển thị dữ liệu theo đúng role và scope. | FLOW-CUSTOMER-VIEW-MANAGE, FLOW-CUSTOMER-CARE-TICKET |
...
| --- | --- | --- |
| VAL-CUSTOMER-DETAIL-001 | User phải có quyền truy cập màn hình. | Bạn không có quyền truy cập màn hình này. |
| VAL-CUSTOMER-DETAIL-002 | Dữ liệu phải thuộc đúng shop/tenant hoặc platform scope. | Không thể truy cập dữ liệu ngoài phạm vi được cấp quyền. |
...
| --- | --- | --- | --- |
| Q-SCR-CUSTOMER-DETAIL-001 | Có cần tích hợp RAG/Chat Lazada ở phase này không? | Ảnh hưởng Customer Support flow. | Later |
...
|---|---|---|
| Screen có Screen ID chưa? | Pass | SCR-CUSTOMER-DETAIL |
| Có route chưa? | Pass | `/app/customers/:customerId` |
