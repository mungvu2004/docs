# SCR-PROFIT-FORMULA-APPROVAL - Profit Formula Approval

## Metadata

| Field | Value |
|---|---|
| Screen ID | SCR-PROFIT-FORMULA-APPROVAL |
| Screen Name | Profit Formula Approval |
| Route | `/app/approvals/profit-formula/:approvalId` |
| Screen Type | Seller |
| Module ID | MOD-REPORT, MOD-SETTING |
...
Duyệt thay đổi công thức lợi nhuận.
...
| --- | --- | --- |
| RULE-PROFIT-FORMULA-APPROVAL-001 | Màn hình chỉ hiển thị dữ liệu theo đúng role và scope. | FLOW-REPORT-VIEW, FLOW-REPORT-EXPORT, FLOW-PROFIT-FORMULA-APPROVAL |
...
| --- | --- | --- |
| VAL-PROFIT-FORMULA-APPROVAL-001 | User phải có quyền truy cập màn hình. | Bạn không có quyền truy cập màn hình này. |
| VAL-PROFIT-FORMULA-APPROVAL-002 | Dữ liệu phải thuộc đúng shop/tenant hoặc platform scope. | Không thể truy cập dữ liệu ngoài phạm vi được cấp quyền. |
...
| --- | --- | --- | --- |
| Q-SCR-PROFIT-FORMULA-APPROVAL-001 | Format export chi tiết cho từng loại báo cáo gồm những cột nào? | Ảnh hưởng report export và template PDF/Excel. | Open |
...
|---|---|---|
| Screen có Screen ID chưa? | Pass | SCR-PROFIT-FORMULA-APPROVAL |
| Có route chưa? | Pass | `/app/approvals/profit-formula/:approvalId` |
