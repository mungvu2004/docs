# SCR-PROFIT-FORMULA-SETTINGS - Profit Formula Settings

## Metadata

| Field | Value |
|---|---|
| Screen ID | SCR-PROFIT-FORMULA-SETTINGS |
| Screen Name | Profit Formula Settings |
| Route | `/app/settings/profit-formula` |
| Screen Type | Seller |
...
Cấu hình công thức lợi nhuận của shop.
...
| --- | --- | --- |
| RULE-PROFIT-FORMULA-SETTINGS-001 | Màn hình chỉ hiển thị dữ liệu theo đúng role và scope. | FLOW-REPORT-VIEW, FLOW-REPORT-EXPORT, FLOW-PROFIT-FORMULA-APPROVAL |
...
| --- | --- | --- |
| VAL-PROFIT-FORMULA-SETTINGS-001 | User phải có quyền truy cập màn hình. | Bạn không có quyền truy cập màn hình này. |
| VAL-PROFIT-FORMULA-SETTINGS-002 | Dữ liệu phải thuộc đúng shop/tenant hoặc platform scope. | Không thể truy cập dữ liệu ngoài phạm vi được cấp quyền. |
...
| --- | --- | --- | --- |
| Q-SCR-PROFIT-FORMULA-SETTINGS-001 | Format export chi tiết cho từng loại báo cáo gồm những cột nào? | Ảnh hưởng report export và template PDF/Excel. | Open |
...
|---|---|---|
| Screen có Screen ID chưa? | Pass | SCR-PROFIT-FORMULA-SETTINGS |
| Có route chưa? | Pass | `/app/settings/profit-formula` |
