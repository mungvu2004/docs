# SCR-REPORT-REVENUE - Revenue Report

## Metadata

| Field | Value |
|---|---|
| Screen ID | SCR-REPORT-REVENUE |
| Screen Name | Revenue Report |
...
Báo cáo doanh thu theo thời gian/filter.
...
| --- | --- | --- |
| RULE-REPORT-REVENUE-001 | Màn hình chỉ hiển thị dữ liệu theo đúng role và scope. | FLOW-REPORT-VIEW, FLOW-REPORT-EXPORT, FLOW-PROFIT-FORMULA-APPROVAL |
...
| --- | --- | --- |
| VAL-REPORT-REVENUE-001 | User phải có quyền truy cập màn hình. | Bạn không có quyền truy cập màn hình này. |
| VAL-REPORT-REVENUE-002 | Dữ liệu phải thuộc đúng shop/tenant hoặc platform scope. | Không thể truy cập dữ liệu ngoài phạm vi được cấp quyền. |
...
| --- | --- | --- | --- |
| Q-SCR-REPORT-REVENUE-001 | Format export chi tiết cho từng loại báo cáo gồm những cột nào? | Ảnh hưởng report export và template PDF/Excel. | Open |
...
|---|---|---|
| Screen có Screen ID chưa? | Pass | SCR-REPORT-REVENUE |
| Có route chưa? | Pass | `/app/reports/revenue` |
