# SCR-REPORTS-OVERVIEW - Reports Overview

## Metadata

| Field | Value |
|---|---|
| Screen ID | SCR-REPORTS-OVERVIEW |
| Screen Name | Reports Overview |
| Route | `/app/reports` |
| Screen Type | Seller |
...
Xem danh sách các báo cáo có thể truy cập.
...
| --- | --- | --- |
| RULE-REPORTS-OVERVIEW-001 | Màn hình chỉ hiển thị dữ liệu theo đúng role và scope. | FLOW-REPORT-VIEW, FLOW-REPORT-EXPORT, FLOW-PROFIT-FORMULA-APPROVAL |
...
| --- | --- | --- |
| VAL-REPORTS-OVERVIEW-001 | User phải có quyền truy cập màn hình. | Bạn không có quyền truy cập màn hình này. |
| VAL-REPORTS-OVERVIEW-002 | Dữ liệu phải thuộc đúng shop/tenant hoặc platform scope. | Không thể truy cập dữ liệu ngoài phạm vi được cấp quyền. |
...
| --- | --- | --- | --- |
| Q-SCR-REPORTS-OVERVIEW-001 | Format export chi tiết cho từng loại báo cáo gồm những cột nào? | Ảnh hưởng report export và template PDF/Excel. | Open |
...
|---|---|---|
| Screen có Screen ID chưa? | Pass | SCR-REPORTS-OVERVIEW |
| Có route chưa? | Pass | `/app/reports` |
