# SCR-SELLER-NOTIFICATIONS - Notifications

## Metadata

| Field | Value |
|---|---|
| Screen ID | SCR-SELLER-NOTIFICATIONS |
| Screen Name | Notifications |
| Route | `/app/notifications` |
| Screen Type | Seller |
| Module ID | MOD-NOTIFICATION |
| Related Feature IDs | FEAT-NOTI-TOAST, FEAT-NOTI-SYNC-ERROR, FEAT-NOTI-LOW-STOCK, FEAT-NOTI-APPROVAL, FEAT-NOTI-SUBSCRIPTION |
| Related Flow IDs | FLOW-NOTIFICATION-HANDLE |
| Allowed Roles | All seller-side roles |
...
Xem thông báo hệ thống, approval, sync error, low stock, subscription.
...
| --- | --- | --- |
| All seller-side roles | View / Limited by permission | Theo permission matrix. |
...
| --- | --- | --- | --- | --- |
| User/Setting/Log/Notification data | Dữ liệu chính theo loại màn hình. | MOD-NOTIFICATION | Yes | Theo scope shop. |
...
| --- | --- | --- | --- | --- | --- |
| ACT-MANAGE | Manage / View | All seller-side roles | User thao tác trên màn | Dữ liệu được cập nhật hoặc hiển thị theo quyền. | FLOW-NOTIFICATION-HANDLE |
...
| --- | --- | --- |
| RULE-SELLER-NOTIFICATIONS-001 | Màn hình chỉ hiển thị dữ liệu theo đúng role và scope. | FLOW-NOTIFICATION-HANDLE |
...
| --- | --- | --- |
| VAL-SELLER-NOTIFICATIONS-001 | User phải có quyền truy cập màn hình. | Bạn không có quyền truy cập màn hình này. |
| VAL-SELLER-NOTIFICATIONS-002 | Dữ liệu phải thuộc đúng shop/tenant hoặc platform scope. | Không thể truy cập dữ liệu ngoài phạm vi được cấp quyền. |
...
| --- | --- | --- | --- |
| Q-SCR-SELLER-NOTIFICATIONS-001 | Permission chi tiết cho từng field/action sẽ chốt ở Permission Matrix thế nào? | Ảnh hưởng UI action visibility. | Open |
...
|---|---|---|
| Screen có Screen ID chưa? | Pass | SCR-SELLER-NOTIFICATIONS |
| Có route chưa? | Pass | `/app/notifications` |
| Có map feature chưa? | Pass | FEAT-NOTI-TOAST, FEAT-NOTI-SYNC-ERROR, FEAT-NOTI-LOW-STOCK, FEAT-NOTI-APPROVAL, FEAT-NOTI-SUBSCRIPTION |
| Có map flow chưa? | Pass | FLOW-NOTIFICATION-HANDLE |
| Có allowed roles chưa? | Pass | All seller-side roles |
