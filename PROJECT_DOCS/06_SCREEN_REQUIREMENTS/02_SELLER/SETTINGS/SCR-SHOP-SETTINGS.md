# SCR-SHOP-SETTINGS - Shop Settings

## Metadata

| Field | Value |
|---|---|
| Screen ID | SCR-SHOP-SETTINGS |
| Screen Name | Shop Settings |
| Route | `/app/settings` |
| Screen Type | Seller |
| Module ID | MOD-SETTING |
| Related Feature IDs | FEAT-SETTING-SHOP-PROFILE, FEAT-SETTING-INVENTORY, FEAT-SETTING-CHANNEL |
| Related Flow IDs | FLOW-SETTING-MANAGE |
| Allowed Roles | ROLE-SHOP-OWNER, ROLE-SHOP-MANAGER limited |
...
Cấu hình shop, inventory threshold, channel settings.
...
| --- | --- | --- | --- | --- |
| User/Setting/Log/Notification data | Dữ liệu chính theo loại màn hình. | MOD-SETTING | Yes | Theo scope shop. |
...
| --- | --- | --- | --- | --- | --- |
| ACT-MANAGE | Manage / View | ROLE-SHOP-OWNER, ROLE-SHOP-MANAGER limited | User thao tác trên màn | Dữ liệu được cập nhật hoặc hiển thị theo quyền. | FLOW-SETTING-MANAGE |
...
| --- | --- | --- |
| RULE-SHOP-SETTINGS-001 | Màn hình chỉ hiển thị dữ liệu theo đúng role và scope. | FLOW-SETTING-MANAGE |
...
| --- | --- | --- |
| VAL-SHOP-SETTINGS-001 | User phải có quyền truy cập màn hình. | Bạn không có quyền truy cập màn hình này. |
| VAL-SHOP-SETTINGS-002 | Dữ liệu phải thuộc đúng shop/tenant hoặc platform scope. | Không thể truy cập dữ liệu ngoài phạm vi được cấp quyền. |
...
| --- | --- | --- | --- |
| Q-SCR-SHOP-SETTINGS-001 | Permission chi tiết cho từng field/action sẽ chốt ở Permission Matrix thế nào? | Ảnh hưởng UI action visibility. | Open |
...
|---|---|---|
| Screen có Screen ID chưa? | Pass | SCR-SHOP-SETTINGS |
| Có route chưa? | Pass | `/app/settings` |
| Có map feature chưa? | Pass | FEAT-SETTING-SHOP-PROFILE, FEAT-SETTING-INVENTORY, FEAT-SETTING-CHANNEL |
| Có map flow chưa? | Pass | FLOW-SETTING-MANAGE |
| Có allowed roles chưa? | Pass | ROLE-SHOP-OWNER, ROLE-SHOP-MANAGER limited |
