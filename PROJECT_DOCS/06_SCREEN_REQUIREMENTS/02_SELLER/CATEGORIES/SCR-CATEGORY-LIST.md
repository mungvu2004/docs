# SCR-CATEGORY-LIST - Category List

## Metadata

| Field | Value |
|---|---|
| Screen ID | SCR-CATEGORY-LIST |
| Screen Name | Category List |
...
Xem và quản lý danh mục sản phẩm của shop.
...
| --- | --- | --- |
| RULE-CATEGORY-LIST-001 | Màn hình chỉ hiển thị dữ liệu theo đúng role và scope. | FLOW-CATEGORY-MANAGE |
...
| --- | --- | --- |
| VAL-CATEGORY-LIST-001 | User phải có quyền truy cập màn hình. | Bạn không có quyền truy cập màn hình này. |
| VAL-CATEGORY-LIST-002 | Dữ liệu phải thuộc đúng shop/tenant hoặc platform scope. | Không thể truy cập dữ liệu ngoài phạm vi được cấp quyền. |
...
| --- | --- | --- | --- |
| Q-SCR-CATEGORY-LIST-001 | Lazada category tree/attribute mapping sẽ được sync và hiển thị chi tiết đến mức nào? | Ảnh hưởng category form. | Pending API Verification |
...
|---|---|---|
| Screen có Screen ID chưa? | Pass | SCR-CATEGORY-LIST |
| Có route chưa? | Pass | `/app/categories` |
