# SCR-CATEGORY-FORM - Category Create/Edit

## Metadata

| Field | Value |
|---|---|
| Screen ID | SCR-CATEGORY-FORM |
| Screen Name | Category Create/Edit |
| Route | `/app/categories/new, /app/categories/:categoryId/edit` |
| Screen Type | Seller |
| Module ID | MOD-CATEGORY |
| Related Feature IDs | FEAT-CATEGORY-LIST, FEAT-CATEGORY-CREATE, FEAT-CATEGORY-UPDATE, FEAT-CATEGORY-DEACTIVATE, FEAT-CATEGORY-LAZADA-MAPPING |
| Related Flow IDs | FLOW-CATEGORY-MANAGE |
| Allowed Roles | ROLE-SHOP-OWNER, ROLE-SHOP-MANAGER, ROLE-PRODUCT-STAFF |
| Priority | Must-have |
| Status | Draft |
...
Tạo/sửa danh mục và mapping Lazada category nếu cần.
...
| --- | --- | --- | --- | --- |
| Category name | Tên danh mục. | Category | Yes |  |
| Category status | Active/Inactive. | Category | Yes |  |
| Lazada mapping | Mapping category Lazada nếu có. | Category Mapping | No | Phụ thuộc API Lazada. |
...
| --- | --- | --- | --- | --- | --- |
| ACT-CATEGORY-CREATE | Create Category | ROLE-SHOP-OWNER, ROLE-SHOP-MANAGER, ROLE-PRODUCT-STAFF | Submit form | Category được tạo. | FLOW-CATEGORY-MANAGE |
| ACT-CATEGORY-UPDATE | Update Category | ROLE-SHOP-OWNER, ROLE-SHOP-MANAGER, ROLE-PRODUCT-STAFF | Save changes | Category được cập nhật. | FLOW-CATEGORY-MANAGE |
| ACT-CATEGORY-DEACTIVATE | Deactivate Category | ROLE-SHOP-OWNER, ROLE-SHOP-MANAGER | Click deactivate | Category ngừng sử dụng, không xóa cứng nếu có product. | FLOW-CATEGORY-MANAGE |
...
| --- | --- | --- |
| RULE-CATEGORY-FORM-001 | Màn hình chỉ hiển thị dữ liệu theo đúng role và scope. | FLOW-CATEGORY-MANAGE |
...
| --- | --- | --- | --- | --- | --- |
| Category Name | Text | Yes | Không rỗng | Thời trang nữ |  |
| Parent Category | Select | No | Valid category | Thời trang | Nếu hỗ trợ phân cấp. |
| Lazada Category Mapping | Select/Search | No | Valid mapping | Lazada category | Chờ API/category tree. |
...
| --- | --- | --- |
| VAL-CATEGORY-FORM-001 | User phải có quyền truy cập màn hình. | Bạn không có quyền truy cập màn hình này. |
| VAL-CATEGORY-FORM-002 | Dữ liệu phải thuộc đúng shop/tenant hoặc platform scope. | Không thể truy cập dữ liệu ngoài phạm vi được cấp quyền. |
...
| --- | --- | --- | --- | --- |
| Deactivate Category | Yes | No | N/A | Không xóa cứng nếu đang có sản phẩm. |
...
| --- | --- | --- |
| Create/update/deactivate category | Recommended | actor, categoryId, before/after, time |
...
| --- | --- |
| SCR-PRODUCT-CREATE | Product cần chọn category. |
| SCR-PRODUCT-EDIT | Product dùng category. |
...
| --- | --- | --- | --- |
| Q-SCR-CATEGORY-FORM-001 | Lazada category tree/attribute mapping sẽ được sync và hiển thị chi tiết đến mức nào? | Ảnh hưởng category form. | Pending API Verification |
...
|---|---|---|
| Screen có Screen ID chưa? | Pass | SCR-CATEGORY-FORM |
| Có route chưa? | Pass | `/app/categories/new, /app/categories/:categoryId/edit` |
| Có map feature chưa? | Pass | FEAT-CATEGORY-LIST, FEAT-CATEGORY-CREATE, FEAT-CATEGORY-UPDATE, FEAT-CATEGORY-DEACTIVATE, FEAT-CATEGORY-LAZADA-MAPPING |
| Có map flow chưa? | Pass | FLOW-CATEGORY-MANAGE |
| Có allowed roles chưa? | Pass | ROLE-SHOP-OWNER, ROLE-SHOP-MANAGER, ROLE-PRODUCT-STAFF |
