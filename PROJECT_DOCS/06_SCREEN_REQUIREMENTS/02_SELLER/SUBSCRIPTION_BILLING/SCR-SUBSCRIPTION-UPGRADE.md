# SCR-SUBSCRIPTION-UPGRADE - Upgrade Plan

## Metadata

| Field | Value |
|---|---|
| Screen ID | SCR-SUBSCRIPTION-UPGRADE |
| Screen Name | Upgrade Plan |
| Route | `/app/subscription/upgrade` |
| Screen Type | Seller |
...
| --- | --- | --- |
| RULE-SUBSCRIPTION-UPGRADE-001 | Màn hình chỉ hiển thị dữ liệu theo đúng role và scope. | FLOW-SUBSCRIPTION-UPGRADE-PAYMENT, FLOW-SUBSCRIPTION-DOWNGRADE, FLOW-SUBSCRIPTION-INVOICE-RECORD, FLOW-SUBSCRIPTION-PASTDUE-SUSPEND |
...
| --- | --- | --- |
| VAL-SUBSCRIPTION-UPGRADE-001 | User phải có quyền truy cập màn hình. | Bạn không có quyền truy cập màn hình này. |
| VAL-SUBSCRIPTION-UPGRADE-002 | Dữ liệu phải thuộc đúng shop/tenant hoặc platform scope. | Không thể truy cập dữ liệu ngoài phạm vi được cấp quyền. |
...
| --- | --- | --- | --- |
| Q-SCR-SUBSCRIPTION-UPGRADE-001 | Chi tiết thời gian hết hạn QR và chính sách retry payment là gì? | Ảnh hưởng UX payment. | Open |
...
|---|---|---|
| Screen có Screen ID chưa? | Pass | SCR-SUBSCRIPTION-UPGRADE |
| Có route chưa? | Pass | `/app/subscription/upgrade` |
