# SCR-SUBSCRIPTION-CURRENT-PLAN - Current Plan

## Metadata

| Field | Value |
|---|---|
| Screen ID | SCR-SUBSCRIPTION-CURRENT-PLAN |
| Screen Name | Current Plan |
...
Xem gói hiện tại, giới hạn và trạng thái subscription.
...
| --- | --- | --- |
| RULE-SUBSCRIPTION-CURRENT-PLAN-001 | Màn hình chỉ hiển thị dữ liệu theo đúng role và scope. | FLOW-SUBSCRIPTION-UPGRADE-PAYMENT, FLOW-SUBSCRIPTION-DOWNGRADE, FLOW-SUBSCRIPTION-INVOICE-RECORD, FLOW-SUBSCRIPTION-PASTDUE-SUSPEND |
...
| --- | --- | --- |
| VAL-SUBSCRIPTION-CURRENT-PLAN-001 | User phải có quyền truy cập màn hình. | Bạn không có quyền truy cập màn hình này. |
| VAL-SUBSCRIPTION-CURRENT-PLAN-002 | Dữ liệu phải thuộc đúng shop/tenant hoặc platform scope. | Không thể truy cập dữ liệu ngoài phạm vi được cấp quyền. |
...
| --- | --- | --- | --- |
| Q-SCR-SUBSCRIPTION-CURRENT-PLAN-001 | Chi tiết thời gian hết hạn QR và chính sách retry payment là gì? | Ảnh hưởng UX payment. | Open |
...
|---|---|---|
| Screen có Screen ID chưa? | Pass | SCR-SUBSCRIPTION-CURRENT-PLAN |
| Có route chưa? | Pass | `/app/subscription` |
