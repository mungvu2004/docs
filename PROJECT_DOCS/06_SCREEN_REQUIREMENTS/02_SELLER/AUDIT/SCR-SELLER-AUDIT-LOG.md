# SCR-SELLER-AUDIT-LOG - Seller Audit Log

## Metadata

| Field | Value |
|---|---|
| Screen ID | SCR-SELLER-AUDIT-LOG |
| Screen Name | Seller Audit Log |
| Route | `/app/audit-logs` |
| Screen Type | Seller |
| Module ID | MOD-AUDIT |
| Related Feature IDs | FEAT-AUDIT-ORDER, FEAT-AUDIT-INVENTORY, FEAT-AUDIT-USER-ROLE, FEAT-AUDIT-SUBSCRIPTION, FEAT-AUDIT-SYNC, FEAT-AUDIT-REPORT-FORMULA |
| Related Flow IDs | FLOW-AUDIT-VIEW |
| Allowed Roles | ROLE-SHOP-OWNER, ROLE-SHOP-MANAGER limited, ROLE-ACCOUNTANT limited |
| Priority | Must-have |
| Status | Draft |
...
| ROLE-SHOP-MANAGER limited | View / Limited by permission | Theo permission matrix. |
...
| --- | --- | --- | --- | --- |
| User/Setting/Log/Notification data | Dữ liệu chính theo loại màn hình. | MOD-AUDIT | Yes | Theo scope shop. |
...
| --- | --- | --- | --- | --- | --- |
| ACT-MANAGE | Manage / View | ROLE-SHOP-OWNER, ROLE-SHOP-MANAGER limited, ROLE-ACCOUNTANT limited | User thao tác trên màn | Dữ liệu được cập nhật hoặc hiển thị theo quyền. | FLOW-AUDIT-VIEW |
...
| --- | --- | --- |
| RULE-SELLER-AUDIT-LOG-001 | Màn hình chỉ hiển thị dữ liệu theo đúng role và scope. | FLOW-AUDIT-VIEW |
...
| --- | --- | --- |
| VAL-SELLER-AUDIT-LOG-001 | User phải có quyền truy cập màn hình. | Bạn không có quyền truy cập màn hình này. |
| VAL-SELLER-AUDIT-LOG-002 | Dữ liệu phải thuộc đúng shop/tenant hoặc platform scope. | Không thể truy cập dữ liệu ngoài phạm vi được cấp quyền. |
...
| --- | --- | --- | --- |
| Q-SCR-SELLER-AUDIT-LOG-001 | Permission chi tiết cho từng field/action sẽ chốt ở Permission Matrix thế nào? | Ảnh hưởng UI action visibility. | Open |
...
|---|---|---|
| Screen có Screen ID chưa? | Pass | SCR-SELLER-AUDIT-LOG |
| Có route chưa? | Pass | `/app/audit-logs` |
| Có map feature chưa? | Pass | FEAT-AUDIT-ORDER, FEAT-AUDIT-INVENTORY, FEAT-AUDIT-USER-ROLE, FEAT-AUDIT-SUBSCRIPTION, FEAT-AUDIT-SYNC, FEAT-AUDIT-REPORT-FORMULA |
| Có map flow chưa? | Pass | FLOW-AUDIT-VIEW |
| Có allowed roles chưa? | Pass | ROLE-SHOP-OWNER, ROLE-SHOP-MANAGER limited, ROLE-ACCOUNTANT limited |
